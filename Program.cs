...
namespace Starter
{
    ...
    retry:
            if (tries > 4)
            {
                ...
                Console.WriteLine("Go to http://files.mdnserver.info/MCForge_.dll yourself and download it, please");
            ...
            else
            {
                ...
                Console.WriteLine("Downloading from http://files.mdnserver.info/MCForge_.dll");

                WebClient Client = new WebClient();
                Client.DownloadFile("http://files.mdnserver.info/MCForge_.dll", "MCForge_.dll");
                Client.Dispose();
