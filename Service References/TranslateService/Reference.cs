...
namespace MCForge.TranslateService {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public MCForge.TranslateService.TranslationMatch[] Translations {
            get {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : MCForge.TranslateService.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<MCForge.TranslateService.LanguageService>, MCForge.TranslateService.LanguageService {
        ...
        public MCForge.TranslateService.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, MCForge.TranslateService.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, MCForge.TranslateService.Translation[] translations, string from, string to, MCForge.TranslateService.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public MCForge.TranslateService.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, MCForge.TranslateService.TranslateOptions options) {
        ...
        public MCForge.TranslateService.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, MCForge.TranslateService.TranslateOptions options) {
