							...
							case "b":
								switch (text[3])
								{
									...
									case "t":
										...
										else if (it.BalanceTeams == false) { Player.SendMessage(p, "TNT Wars: Team balancing is currently siabled"); return; }
										break;
							...
							case "ffire":
								switch (text[3])
								{
									...
									case "t":
										...
										else if (it.TeamKills == false) { Player.SendMessage(p, "TNT Wars: Team killing is currently siabled"); return; }
										break;
