        ...
        public override void Use(Player p, string message)
        {
            ...
            try
            {
                ...
                if (File.Exists("levels/" + message + ".lvl"))
                {
                    ...
                    if (Server.useMySQL) MySQL.executeQuery("DROP TABLE `Block" + message + "`, `Portals" + message + "`, `Messages" + message + "`, `Zone" + message + "`"); else .executeQuery("DROP TABLE `Block" + message + "`, `Portals" + message + "`, `Messages" + message + "`, `Zone" + message + "`");
