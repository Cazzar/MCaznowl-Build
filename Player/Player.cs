                ...
                if (text[0] == '!')
                {
                    if (PlayingTntWars)
                    {
                        ...
                        if (it.GameMode == TntWarsGame.TntWarsGameMode.TDM)
                        {
                            ...
                            {
                                if (pl.Red && p.Red) SendMessage(p.p, "To Team " + c.red + "-" + color + prefix + name + Server.DefaultColor + "- " + newtext);
                                if (pl.Blue && p.Blue) SendMessage(p.p, "To Team " + c.blue + "-" + color + prefix + name + Server.DefaultColor + "- " + newtext);
                            }
